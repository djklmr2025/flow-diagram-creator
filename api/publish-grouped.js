...
import { normalizeProjectInPlace } from "./_shared/normalize.js";
...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    sendJson(res, 200, {
      ...
      usage: {
        ...
        notes:
          "Guarda selección rápida en library/grouped sin pedir PUBLISH_KEY en UI.",
      },
    });
    return;
  }
  ...
  const camera =
    body && body.camera && typeof body.camera === "object"
      ? body.camera
      : { x: 0, y: 0, zoom: 1 };
